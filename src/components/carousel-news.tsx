                ...
                {filteredNews.map((product: New) => {
                  ...
                  return (
                    <div key={product.id} className="p-2">
                      <div className="bg-white dark:bg-slate-800/50 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col h-[450px] overflow-hidden group relative border-[1px] border-zinc-300 dark:border-zinc-800">
                        ...
                        <div className="p-4 flex flex-col flex-grow">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300 flex-grow">
                            {truncateText(product.content, 150)}
                          </p>
