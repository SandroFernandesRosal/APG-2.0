...
// O componente 'LeaderCard' para os itens principais não muda.
function LeaderCard({
  icon,
  title,
  subtitle,
...
export default function MinisterioHeader() {
  ...
  // URLs de exemplo para as imagens. Substitua pelas suas.
  ...
  const diaconatoImages = [
    'https://images.unsplash.com/photo-1611601322175-28e6b3542426?w=100',
    'https://images.unsplash.com/photo-1556157382-97eda2d62296?w=100',
    'https://images.unsplash.com/photo-1628890923662-2cb23c2a01a8?w=100',
  ]
  const presbiterosImages = [
    'https://images.unsplash.com/photo-1557862921-37829c790f19?w=100',
    'https://images.unsplash.com/photo-1639747280804-dd2d6b3d88ac?w=100',
  ]
  const equipesImages = [
    'https://images.unsplash.com/photo-1529068755536-a5ade0dcb4e8?w=100',
    ...
    <section className="w-full bg-gray-50 dark:bg-gray-900/70 py-16 md:py-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          />
          {/* --- ALTERAÇÃO AQUI --- */}
          {/* Este é o novo cartão, com o seu texto e sem o ícone grande. */}
          <div
