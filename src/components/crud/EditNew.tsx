...
export default function EditNew({
  ...
  const modalContent = (
    <form
      ref={formRef}
      className="fixed left-0 top-0 z-[99999] flex min-h-screen w-[100vw] flex-col items-center justify-center bg-black/70 backdrop-blur-md p-4"
      style={{ zIndex: 99999 }}
      onSubmit={handleSubmit}
    >
      <div
        className="flex flex-col items-center justify-center rounded-xl bg-white dark:bg-gray-800 shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden relative z-[99999]"
        style={{ zIndex: 99999 }}
      >
        {/* Header - Fixo */}
        ...
        {/* Conteúdo scrollável */}
        <div className="w-full overflow-y-auto max-h-[calc(90vh-140px)]">
