...
export default function AddNew({ setOpenNew }: AddNewProps) {
  ...
  return (
    <form
      ref={formRef}
      className="fixed left-0 top-0 z-50 flex min-h-screen w-[100vw] flex-col items-center justify-center bg-black/50 backdrop-blur-sm p-4"
      onSubmit={handleSubmit}
    >
      <div className="flex flex-col rounded-xl bg-white dark:bg-gray-800 shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex-shrink-0">
        {/* Header */}
        <div className="flex items-center justify-between w-full p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex-shrink-0">
        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="w-full p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800 min-h-[120px]">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end w-full p-4 border-t border-gray-200 dark:border-gray-700 space-x-3 bg-white dark:bg-gray-800 flex-shrink-0">
          <button
            type="button"
            onClick={() => setOpenNew(false)}
