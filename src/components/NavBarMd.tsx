...
export default function NavBarMd({ activePage, handleClick }: NavBarMdProps) {
  return (
    <nav
      className={`font-Roboto font-bold hidden w-[100vw] items-center justify-center gap-3 overflow-x-auto bg-bglight/30 p-3 pb-[5px] backdrop-blur-sm dark:bg-bgdark/30 md:flex lg:gap-4`}
    >
      <Link href="/">
        <div
