            ...
            {dataMinisterio.map((product: Ministerio) => {
              return (
                <div
                  ...
                  key={product.id}
                >
                  <div className="border-b-[3px] border-primary h-[50%] py-2 flex justify-center items-center">
                    <Image
                      src={product.coverUrl}
                      width={130}
                      height={130}
                      alt={product.title}
                      className="group-hover:scale-105 transition-transform duration-500 p-1 object-center rounded-full border-[1px] border-zinc-300 dark:border-zinc-800"
                    />
                  </div>
