...
export default function ItemUser({
  ...
  useEffect(() => {
    if (modalOpen) {
      ...
      // Resetar loading quando fechar o modal
      setIsLoadingToken(false)
    }
  }, [modalOpen])
    ...
    <div className="hidden md:flex">
      ...
      {modalOpen && (
        <>
          ...
          <div className="fixed inset-0 z-20" onClick={toggleModal} />

          {/* Modal */}
          <div
            className="absolute top-20 right-[15%] lg:right-[20%] bg-white dark:bg-gray-800 z-30 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 min-w-[320px] max-h-[80vh]"
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-primary/10 to-secundary/10 dark:from-primary/20 dark:to-secundary/20 p-4 sticky top-0 z-10">
              ...
              <div className="flex items-center gap-3">
                {isLoadingToken ? (
                  <>
                    {/* Skeleton loading para avatar */}
                    <div className="relative">
                      <div className="w-15 h-15 rounded-full bg-gray-300 dark:bg-gray-600 animate-pulse border-2 border-gray-200 dark:border-gray-700"></div>
                      <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gray-300 dark:bg-gray-600 rounded-full border-2 border-white dark:border-gray-800 animate-pulse"></div>
                    </div>
                    {/* Skeleton loading para nome e role */}
